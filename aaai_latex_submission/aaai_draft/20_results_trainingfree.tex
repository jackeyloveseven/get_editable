...
training, same 30 held-out subjects) is the same-class trained-adapter
baseline. \texttt{krea2-identity-edit} (community LoRA on the 12.9B
general-domain Krea-2-Turbo, zero retraining by us) is a purpose-trained,
architecturally distinct in-context adapter -- not an architecture-matched
comparison, but the strongest publicly available bar we could run at zero
